...
impl Server {
    ...
    /// Receives ingoing messages from peers via TCP.
    ...
    /// Receives incoming messages from a peer via TCP.
    ...
    /// Sends outgoing messages to peers via TCP.
    async fn tcp_send(
        peers: HashMap<NodeID, String>,
    ...
    /// Sends outgoing messages to a peer, continuously reconnecting.
    ...
    /// Sends outgoing messages to a peer via a TCP session.
