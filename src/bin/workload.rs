//! Runs raDB workload benchmarks. For example, a read-only
...
#[derive(clap::Parser)]
#[command(about = "Runs raDB workload benchmarks.", version, propagate_version = true)]
struct Command {
    #[command(flatten)]
    runner: Runner,
